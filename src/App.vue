...
<template>
  <header class=" bg-[#0aa6c1]">
    <svg width="20%" height="50%" viewBox="0 0 500 150" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="
              fill-rule: evenodd;
              clip-rule: evenodd;
              stroke-miterlimit: 1.5;
            ">
            <rect id="Mesa-de-trabajo4" serif:id="Mesa de trabajo4" x="0" y="0" width="400" height="400" style="fill: none"></rect>
            <g>
              <g>
                <g>
                  <g id="Capa2">
    ...
    <div class="max-w-screen-xl px-4 py-3 mx-auto md:px-6">
        <div class="flex items-center">
            <ul class="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium ">
                ...
                <li class="hover:-translate-y-1 hover:scale-110 duration-300 hover:text-cyan-900">
                  <RouterLink to="/about">Registro</RouterLink>
